...
/// zeroGPin = 11, gSelectPin = 10, xPin = A0, yPin = A1, zPin = A2.
...
// A0,A1,A2 as input for X,Y,Z and digital pins 13,12,11,10 for sleep,
/// selftest, zeroG and gSelect
/// </summary>
...
/// offset values for the x,y,z axis.
...
/// (now only takes 3.3 or 5 as parameter)
/// default is 5 when no AREF is used. When you want to use 3.3 AREF,
/// put a wire between the AREF pin and the
...
/// (LOW) using a boolean HIGH (1.5 G) or LOW (6 G)
/// </summary>
...
/// this does nothing) there is a 2 ms delay, due to enable response time
/// (datasheet: typ 0.5 ms, max 2 ms)
/// </summary>
...
/// port of the Arduino as a integer
/// </summary>
...
/// the raw data. Used in getXVoltage, getYVoltage, getZVoltage
/// </summary>
...
/// degrees derived from the raw data. Used in getXAccel, getYAccel,
/// getZAccel
/// </summary>
...
/// axis will be set to 100 = 1G
/// WARNING WHEN CALIBRATED YOU HAVE TO MAKE SURE THE Z-AXIS IS
/// PERPENDICULAR WITH THE EARTHS SURFACE
/// </summary>
...
/// surface x=1,y=2,z=3 is positive or
...
// measurements to average the error a little bit
    {
            x = x+getXAccel();
            y = y+getYAccel();
            z = z+getZAccel();
...
accelero.begin(13, 12, 11, 10, A0, A1, A2);
  ...
  // WA¯NE: do tego jeszcze pod³±czyæV3 do AREF'u!!!!
...
void noteOn(int cmd, int pitch, int velocity) {
  ...
  Serial1.write(0xB2); // MIDI control change; channel 3
  Serial1.write(1); // MIDI controller #1
